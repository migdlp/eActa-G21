...
<form action="FormAdminServlet" method="post">
        <tr>
        <td><input type="text" id="name" name="name" value="${actai.name}" /></td>
        <td><input type="hidden" id="email" name="email" value="${actai.email}" />${actai.email}</td>
        <td><input type="hidden" id="email" name="email" value="${actai.email}" />${actai.email}</td>
        ...
        <td><input type="text" id="mark" name="mark" value="${actai.mark}" /></td>
